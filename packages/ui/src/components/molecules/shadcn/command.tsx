...
const CommandResponsiveDialog = ({
  title = "Command Menu",
  description = "This is a command menu",
  children,
  shouldFilter = true,
    showCloseButton = true,
  ...props
}: React.ComponentProps<typeof Dialog> & { title?: string; description?: string;   showCloseButton?: boolean
  shouldFilter?: boolean; children: React.ReactNode }) => {
